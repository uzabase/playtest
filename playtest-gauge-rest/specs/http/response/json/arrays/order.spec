# レスポンスのJSONにおいてJSON Pathで配列を取得し、その配列内の要素の順序をアサートできる
...
## 日付/時間の昇順
* レスポンスボディとしてシナリオデータストアに"{\"tests\": [{\"createdAt\": \"2007-12-03T10:15:30\"}, {\"createdAt\": \"2007-12-03T11:15:30\"}, {\"createdAt\": \"2007-12-05T10:15:30\"}]}"を保存する
* レスポンスのJSONの配列"$.tests"が、日付/時間"createdAt"の昇順に並んでいる

## 日付/時間の降順
* レスポンスボディとしてシナリオデータストアに"{\"tests\": [{\"createdAt\": \"2007-12-06T10:15:30\"}, {\"createdAt\": \"2007-12-06T09:15:30\"}, {\"createdAt\": \"2007-12-05T10:15:30\"}]}"を保存する
* レスポンスのJSONの配列"$.tests"が、日付/時間"createdAt"の降順に並んでいる
